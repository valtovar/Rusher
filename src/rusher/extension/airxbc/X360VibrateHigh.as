package rusher.extension.airxbc 
{
  ...
  public class X360VibrateHigh extends Action
  {
    public var amount      :Number = 0.0;
    public var time        :Number = 0.0;
    public var controllerID:uint = 0;
    
    public function X360VibrateHigh(amount:Number, time:Number = -1.0, controllerID:uint = 0) 
    {
      this.amount       = amount      ;
      this.time         = time        ;
    ...
    {
      input_.setVibrationHigh(0.0, controllerID);
    }
    
    override public function update(dt:Number):void 
    {
      input_.setVibrationHigh(amount, controllerID);
