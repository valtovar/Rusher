package idv.cjcat.rusher.input 
{
   ...
   */
  [Inject]
  public final class Mouse extends System
  {
     ...
     */
    public function isPressed():Boolean { return _pressStatus1; }
    /**
     * Whether the pointer button was released between the previous frame and the current frame. 
     * Remains true only for one frame.
     */
    public function isReleased():Boolean { return _releaseStatus1; }
