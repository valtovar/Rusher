package idv.cjcat.rusher.box2d 
{
  ...
  public final class Box2DBody extends Component
  {
    ...
    private var world_:Box2DWorld;
    override public function onAdded():void
    {
      world_ = getSystem(Box2DWorld);
    ...
    override public function onRemoved():void
    {
      ...
      world_.world.DestroyBody(_body);
      world_ = null;
      _body = null;
    }
    ...
    private function createBody():void
    {
      ...
      _body = world_.world.CreateBody(_bodyDef.getBodyDef());
